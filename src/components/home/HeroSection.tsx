      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            ...
            {/* Subtitle */}
            <p className="text-body-lg text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
          ...
          {/* Stats Grid */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto animate-slide-up">
